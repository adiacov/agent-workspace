...
"$ROOT/install.sh" --prefix "$prefix" >"$TEST_TMPDIR/install.out"
...
assert_contains 'installed agent-ws to' "$TEST_TMPDIR/install.out"
assert_contains 'installed version to' "$TEST_TMPDIR/install.out"
